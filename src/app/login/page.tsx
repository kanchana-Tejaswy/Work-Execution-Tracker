  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-6 mx-auto min-h-[80vh] animate-fade-in">
      <div className="flex flex-col gap-2 text-center mb-4">
        ...
        <p className="text-text-secondary text-sm">Access your workspace using your enterprise account.</p>
      </div>
      ...
      {searchParams?.message && (
        <p className="p-4 bg-primary/5 text-primary text-sm text-center rounded-md border border-primary/10">
          {searchParams.message}
        </p>
      )}
      {searchParams?.error && (
